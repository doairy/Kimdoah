...
/**
 * Servlet implementation class HealthInsert
 */
@WebServlet("/insert")
public class HealthInsert extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher rd = request.getRequestDispatcher("/health/insert.jsp");
...
//			healthvo.setHdate(new Date()); //request.getParameter("hdate"));
			...
			healthdao.insert(healthvo); // 여러개 전달 변수명 뒤에 s붙인다.
